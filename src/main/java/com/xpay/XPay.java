 ...
 * XPay Base class
 */
public abstract class XPay {
    /**
     * XPay API BASE URL
     */
//    public static final String LIVE_API_BASE = "https://api.lucfish.com/xpay";
    public static final String LIVE_API_BASE = "https://api-test.lucfish.com/xpay";
    /**
     * version
     */
    ...
    public static void setAcceptLanguage(String acceptLanguage) {
        XPay.acceptLanguage = acceptLanguage;
    }
}
