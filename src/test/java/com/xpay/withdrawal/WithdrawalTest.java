...
public class WithdrawalTest extends XPayTestBase {
     ...
     * 获取提现对象
     */
    @Test public void testWithdrawalRetrieve() throws XPayException {
     ...
     * 获取提现列表
     */
    @Test public void testGetWithdrawalList() throws XPayException {
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("page", 1);
     ...
     * 更新提现对象
     */
    @Test public void testWithdrawalUpdate() throws XPayException {
        Map<String, Object> params = new HashMap<String, Object>();
