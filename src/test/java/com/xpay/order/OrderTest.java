...
public class OrderTest extends XPayTestBase {
     ...
     * 创建 order
     */
    @Test public void testCreateOrder() throws XPayException {
     ...
     * 取消 order
     */
    @Test public void testCancelOrder() throws XPayException {
     ...
     * 查询单个 order
     */
    @Test public void testOrderRetrieve() throws XPayException {
     ...
     * 获取 order 列表
     */
    @Test public void testGetOrderList() throws XPayException {
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("page", 1);
     ...
     * 查询订单中 Payment 对象
     */
    @Test public void testOrderChargeRetrieve() throws XPayException {
        // 查询订单中 Payment 对象
        // 参数一: order id
        // 参数二: charge id
     ...
     * 查询订单中 Payment 列表
     */
    @Test public void testOrderChargeList() throws XPayException {
        Map<String, Object> params = new HashMap<>();
        params.put("page", 1);
     ...
     * 创建 order 退款
     */
    @Test public void testOrderRefundCreate() throws XPayException {
     ...
     * 查询 order 退款
     */
    @Test public void testOrderRefundRetrieve() throws XPayException {
        // 查询 order 退款方法
        // 参数一: orderId
        // 参数二: refundId
     ...
     * 查询 order 退款列表
     */
    @Test public void testOrderRefundList() throws XPayException {
