 ...
 * 接入 webhooks 流程参考开发者中心：https://www.xpay.com/docs/webhooks/webhooks
...
public class WebhooksVerifyExample {
    ...
    public static void main(String[] args) throws Exception {
        Main.projectDir = System.getProperty("user.dir") + "/example/";
        runDemos();
    }
    ...
    public static void runDemos() throws Exception {
        ...
        // 签名数据请从 request 的 header 中获取, key 为 X-Pay-Signature (请忽略大小写, 建议自己做格式化)
