...
具体使用示例参考 [RequestOptionsTest.java](/src/test/java/com/xpay/RequestOptionsTest.java)
...
Payment.create(String apiKey, Map<String, Object> params)
Payment.retrieve(String id, String apiKey)
Payment.retrieve(String id, String apiKey, Map<String, Object> params)
Payment.list(String apiKey, Map<String, Object> params)
Payment.reverse(String id, String apiKey, Map<String, Object> params)
Payment.reverse(String id, String apiKey)

payment.refunds.list(String apiKey, Map<String, Object> params)
payment.refunds.retrieve(String id, String apiKey)
payment.refunds.create(String apiKey, Map<String, Object> params)
...
Refund.create(String payment, String apiKey, Map<String, Object> params)
Refund.retrieve(String payment, String id, String apiKey)
Refund.list(String payment, String apiKey, Map<String, Object>params)
...
```java
String apiKey = "YOUR_API_KEY";
Payment.create(apiKey, params)

// 替换成

String apiKey = "YOUR_API_KEY";
RequestOptions options = new RequestOptionsBuilder().setApiKey(apiKey).build();
Payment.create(params, options);
```
...
`XPay.AcceptLanguage` 改为 `XPay.acceptLanguage`。
...
XPayResponse response = payment.getLastResponse();
